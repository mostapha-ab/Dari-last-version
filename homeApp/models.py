...
class HousePost(models.Model):
    ...
    def __str__(self):
        # return str(self.category) + " From " + str(self.user_owner) + " /"
...
def resizeImage(sender,instance,created,**kwargs):
    if created:
        url = "C:/Users/EVICORP/Downloads/Desktop/Dari/auth/static" + instance.image.url
        img = Image.open(url)
        size = (2000,2000)
        img.thumbnail(size)
        img.save(url)
post_save.connect(resizeImage,sender=Images)
...
# paths = ["house-image_3UE1x21.png","house-image1_NP77wDj.png","houseImage_timVSUP.jpg"]
# def resizeImage(sender,instance,created,**kwargs):
#     if created:
#         url = "C:/Users/EVICORP/Downloads/Desktop/Dari/auth/static" + instance.image.url
#         img = Image.open(url)
...
# im = Image.open(r"C:\Users\EVICORP\Downloads\Desktop\Dari\auth\static\media\images\4k-resolution-wallpaper_110628746_312_LzmsORV.jpg") 