...
def searchPage(request):
    ...
    for item in house_items:
        ...
        if (generated_item == True):
            img_list = ["/media/images/house-image1_NP77wDj.png","/media/images/houseImage_timVSUP.jpg","/media/no-photo.png"]
...
def house_info_page(request,pk):
    ...
    try:
        ...
        if (generated_item == True):
            img_house_list = ["/media/images/house-image1_NP77wDj.png","/media/images/houseImage_timVSUP.jpg","/media/no-photo.png"]
        elif (generated_item == False):
