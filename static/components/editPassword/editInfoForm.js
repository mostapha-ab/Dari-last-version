...
app.component('edit-info-form-sec',{
    ...
    <label for=""><p>Actually Password</p>
        ...
        <span id="actPass-notify" v-show="!valide_actually_password">Your password is too short. It must contain at least 8 characters.</span>
    </label>
    ...
    <label for=""><p>New Password</p>
        ...
        <span id="newPass-notify" v-show="!valide_new_password">Your password is too short. It must contain at least 8 characters.</span>
    </label>
    ...
    <label for=""><p>Confirm Password</p>
        ...
        <span id="conf-notify" v-show="!valide_conf_password">Your password is too short. It must contain at least 8 characters.</span>
    </label>
