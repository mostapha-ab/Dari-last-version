...
app.component('our-form',{
    ...
    <label for=""><p>User Name</p>
        <div class="input-box" :class={errorInput:!valideUserName}>
            <input type="text" name="" id="" v-model="username" placeholder="Enter your User Name Here" maxlength="15">
        </div>
    ...
    <label for=""><p>Organic</p>
        <div class="input-box">
            <input type="text" name="" v-model="biographie" id="" placeholder="Your bio here">
        </div>
    ...
    computed:{
        ...
        valideUserName(){
            ...
            if (username_length >= 5 && username_length <= 15 && !username_exist){
                return true
            }
            return false
        }
        ...
        ,
        valideBio(){
            if (this.biographie.length >= 5 && this.biographie.length < 600){
                return true
            }
            return false
        }
    ...
    mounted(){
        ...
        fetch(user_data_url)
            ...
            .then((res)=>{
                ...
                this.biographie = this.persData[0].bio
