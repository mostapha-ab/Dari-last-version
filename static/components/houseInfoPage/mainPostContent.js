...
app.component('main-content',{
            ...
            <div class="owner-card">
                <div class="cont">
                    <div class="head-card">
                        ...
                        <h3 id="username">{{owner_name}}</h3>
                        <p id="bio">{{owner_bio.substring(0,80)}}</p>
                    </div>

                    <div class="buttons">
                        <button class="phone-num-btn" @click="openOverlay">
                            <img src="http://127.0.0.1:8000/media/phoneIcon.png" alt="">
                            Phone Number
                        </button>

                        <button class="chat-btn">
                            <img src="http://127.0.0.1:8000/media/chatIcon.png" alt="">
                            Chat
                        </button>
                    </div>
                </div>
    ...
    `,
    props : ["images","owner_name","owner_pic","owner_bio"]
    ,
    data() {
        return {
            counter : 0,
