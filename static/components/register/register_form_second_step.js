...
app.component('register-form-second-step',{
    ...
    <div class="second-step">
        ...
        <div class="label">
            ...
            <div class="input-box" id="passwordBox">
                <input type="password" v-model="user_password" placeholder="nter your password At least 8 chars">
            </div>
            <span id="phoneNumberError1">At least 8 characters</span><br>
            <span id="phoneNumberError2">Your password can’t be too similar to your other personal information.</span><br>
            <span id="phoneNumberError3">Your password can’t be a commonly used password.</span><br>
    ...
    methods: {
        ...
        redirectUser(pageName){
            return window.location.href = `http://127.0.0.1:8000/${pageName}`;
        },
        //--- Emitting Event
        ...
        showPasswordError(){
            ...
            document.getElementById("phoneNumberError2").style.color = "#FF6B6B"
        ...
        passwordMatching(){
            var that = this
            if ((this.user_password.length >= 8) && (this.user_password === this.user_password_conf)){
