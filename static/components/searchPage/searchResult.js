...
app.component('search-result',{
    ...
    `
        <section id="hero-mst-ldh">
            <div class="container">
                ...
                <pagination-section :next="next" :prev="prev" :page="page" url_path="http://127.0.0.1:8000/home/search/"></pagination-section>
            </div>
        </section>
    ...
    methods: {
        // Methods Goes Here
        openCard(){
            console.log("send event to parent component")
